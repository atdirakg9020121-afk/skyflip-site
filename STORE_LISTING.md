...
## アプリ名 (Product name)
SkyFlip Clock
（※ 実装の productName と一致。"Clock" は名前かぶり回避で付与。短い説明やキャッチでは語感優先で「SkyFlip」と書いてもよいが、正式名は SkyFlip Clock）
...
## リリースノート（バージョン1.0.0）
SkyFlip Clock 初回リリース。フリップ時計＋天気連動アニメーション、位置情報による自動表示に対応しました。
...
| ネオン夜景 | ¥320 | サイバーパンクな夜の街（ビル群・ネオン・走る光跡） |
